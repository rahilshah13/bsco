...
const textInputStyle = {outline:"none", border:"none", width:"66%", textAlign: "start", height:"5vh", marginTop: isComp ? "2.5vh" : "3vw"};
const coordInputStyle = {width: isComp ? "3.5vw" : "10vw", height:"5vh", outline: "none", border:"none", marginTop: isComp ? "3vh" : "1vh", 
